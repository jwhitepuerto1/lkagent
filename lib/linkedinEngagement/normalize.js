...
// CONFIRMED against a live Unipile /linkedin/search response (2026-08-27) -
// see unipileClient.js searchPeople. No structured company field exists, so
// companyName/companyUrl are always blank, matching the same "only
// confirmed identity fields" principle csvExport.js already follows for
// engagement-derived profiles.
export function normalizeSearchResult(rawItem) {
  ...
  return {
    ...
    publicUrl: rawItem.profile_url || rawItem.public_profile_url || null,
